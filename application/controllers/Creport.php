...
class Creport extends CI_Controller
{
    ...
    public function daywise_sales_report() {
        ...
        $start_date       = $this->input->post('from_date') ?$this->input->post('from_date') : null ;
        $end_date         = $this->input->post('to_date') ? $this->input->post('to_date') : null;
        $customer_id = $this->input->post('customer_id') ?  $this->input->post('customer_id') : null;
        $content     = $this->lreport->daywise_sales_report($customer_id, $start_date, $end_date);

        $this->template->full_admin_html_view($content);
        
    }
    public function daywise_transaction_report() {
        $CI = &get_instance();
        $this->auth->check_admin_auth();
        $CI->load->library('lreport');
        ...
        $end_date         = $this->input->post('to_date') ? $this->input->post('to_date') : null;
        $customer_id = $this->input->post('customer_id') ?  $this->input->post('customer_id') : null;
        $content     = $this->lreport->daywise_transaction_report($customer_id, $start_date, $end_date);

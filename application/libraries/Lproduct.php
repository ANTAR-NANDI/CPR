...
class Lproduct
{
    ...
    public function barcode_print_html($barcode_id)
    {
        ...
        $chapterList = $CI->parser->parse('product/barcode_print_page2', $data, true);
        return $chapterList;
    }
    ...
    public function product_edit_data($product_id)
    {
        ...
        @$vat_tax_data = $CI->Products->vat_tax_data($product_id);
        ...
        $data['product_name_bn']     = $product_detail[0]['product_name_bn'];
        ...
        $data['tag_code']             = $product_detail[0]['tag_code'];

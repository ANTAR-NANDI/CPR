...
class Lreport extends CI_Model
{
    ...
    public function product_wise_purchase_report()
    {
        ...
        $data['title'] = 'Purchase Report( Product Wise)';
        ...
        $data['outlet_list'] =  $CI->Rqsn->outlet_list_to();
        $data['cw_list'] =  $CI->Rqsn->cw_list();
        $data['heading_text'] = "Purchase Report( Product Wise)";

        //   echo '<pre>';print_r($data['outlet_list']);exit();
        $reportList = $CI->parser->parse('report/productwise_purchase_report', $data, true);
        return $reportList;
    }
    ...
    public function supplier_wise_sales_report()
    {
        ...
        $logged_outlet_id = $this->session->userdata('outlet_id');
        // $data['outlet_list'] =  $CI->Rqsn->outlet_list_to();
        // $data['cw_list'] =  $CI->Rqsn->cw_list();

        $data['title'] = 'Sales Report( Supplier Wise)';
        ...
        $data['outlet_list'] =  $CI->Rqsn->outlet_list_to();
        $data['cw_list'] =  $CI->Rqsn->cw_list();
        $data['supplier_list'] = $CI->Suppliers->supplier_list();
        $data['heading_text'] = "Sales Report( Supplier Wise)";

        //echo '<pre>';print_r($data);exit();
        $reportList = $CI->parser->parse('report/supplier_wise_sales_report', $data, true);
        return $reportList;
    }
    //Purchase details data
    public function product_purchase_details_report($product_id, $from_date = null, $to_date = null)
    {
        ...
        $currency_details = $CI->Web_settings->retrieve_setting_editdata();
        $company_info = $CI->Reports->retrieve_company();
        $product_purchase_detail = $CI->Reports->product_purchase_details_data($product_id, $from_date, $to_date);
        //   if (!empty($product_purchase_detail)) {
        //       foreach ($product_purchase_detail as $k => $v) {
        //           $product_purchase_detail[$k]['purchase_date'] = $CI->occational->dateConvert($product_purchase_detail[$k]['purchase_date']);
        //       }
        //   }
        $data['currency'] = $currency_details[0]['currency'];
        $data['currency_details'] = $currency_details;
        $data['company'] = $company_info;
        $data['product_sales_detail'] = $product_purchase_detail;
        //  echo "<pre>";
        //  print_r($data);
        //  exit();
        $chapterList = $CI->parser->parse('report/details_product_purchase', $data, true);
        return $chapterList;
    }

    public function expiry_stock_report_single_item()
    {
        $CI = &get_instance();
        $CI->load->model('Reports');
        $CI->load->model('Products');
        ...
        $CI->load->model('categories');
        $CI->load->model('suppliers');
        $data['title'] = 'Expiry Stock Report';
        ...
        $data['heading_text'] = "Stock Purchase";
        // echo "<pre>";
        // print_r($data);
        // exit();
        $reportList = $CI->parser->parse('report/expiry_stock_report', $data, true);
        return $reportList;
    }
    ...
    public function supplier_wise_stock_report()
    {
        ...
        $CI->load->model('categories');
        $CI->load->model('suppliers');
        $data['title'] = 'Supplier Wise Stock Report';
        ...
        $data['cw_list'] =  $CI->Rqsn->cw_list();
        $data['purchase_id'] =  $CI->Reports->all_purchase_id();
        $data['heading_text'] = display('supplier_wise_stock_report');
        $data['logged_outlet_id'] = $logged_outlet_id;
        // echo "<pre>";
        // print_r($data);
        // exit();
        $reportList = $CI->parser->parse('report/supplier_wise_stock_report', $data, true);
        return $reportList;
    }
    ...
    public function retrieve_all_reports($per_page = null, $page = null)
    {
        ...
        if (!empty($sales_report)) {
            ...
            foreach ($sales_report as $k => $v) {
                $i++;
                $sales_report[$k]['sl'] = $i;
                $sales_report[$k]['sales_date'] = $CI->occational->dateConvert($sales_report[$k]['sales_date']);
    ...
    public function todays_sales_report($links = null, $per_page = null, $page = null)
    {
        ...
        //     $outlet_id = $this->Warehouse->outlet_or_cw_logged_in()[0]['outlet_id'];
        // }
        $sales_report = $this->Reports->todays_sales_report(null, null, $logged_outlet_id);
        // $outlet_list = $CI->Warehouse->get_outlet_user();
        ...
        if (!empty($sales_report)) {
            ...
            foreach ($sales_report as $k => $v) {
                ...
                // if ($sales_report[$k]['outlet_name'] == '') {
                //     $sales_report[$k]['outlet_name'] = 'Central Warehouse';
                // }

                if ($sales_report[$k]['outlet_id'] == '') {
                    $sales_report[$k]['outlet_name'] = 'Super Admin';
                } elseif ($sales_report[$k]['outlet_id'] == 'HK7TGDT69VFMXB7') {
                    $sales_report[$k]['outlet_name'] = $CI->Warehouse->get_central_warehouse($sales_report[$k]['outlet_id'])[0]['central_warehouse'];
                } else {
                    $sales_report[$k]['outlet_name'] = $CI->Warehouse->get_outlet($sales_report[$k]['outlet_id'])[0]['outlet_name'];
                }
            }
        }
        // echo '<pre>';
        ...
        $data = array(
            ...
            'software_info' => $currency_details,
            'company' => $company_info,
            'logged_outlet_id' => $logged_outlet_id,
        );
    ...
    public function todays_purchase_report($links = null, $per_page = null, $page = null)
    {
        ...
        $purchase_report = $CI->Reports->todays_purchase_report('', '', $logged_outlet_id);
        ...
        if (!empty($purchase_report)) {
            ...
            foreach ($purchase_report as $k => $v) {
                ...
                $purchase_report[$k]['prchse_date'] = $CI->occational->dateConvert($purchase_report[$k]['purchase_date']);
                $purchase_amount = $purchase_amount + $purchase_report[$k]['grand_total_amount'];
                // if ($purchase_report[$k]['outlet_name'] == '') {
                //     $purchase_report[$k]['outlet_name'] = 'Central Warehouse';
                // }

                if ($purchase_report[$k]['outlet_id'] == '') {
                    $purchase_report[$k]['outlet_name'] = 'Super Admin';
                } elseif ($purchase_report[$k]['outlet_id'] == 'HK7TGDT69VFMXB7') {
                    $purchase_report[$k]['outlet_name'] = $CI->Warehouse->get_central_warehouse($purchase_report[$k]['outlet_id'])[0]['central_warehouse'];
                } else {
                    $purchase_report[$k]['outlet_name'] = $CI->Warehouse->get_outlet($purchase_report[$k]['outlet_id'])[0]['outlet_name'];
                }
            }
        }
    ...
    public function retrieve_dateWise_PurchaseReports($start_date, $end_date, $links, $per_page, $page, $outlet_id, $supplier_id)
    {
        $CI = &get_instance();
        $CI->load->model('Reports');
        $CI->load->model('Rqsn');
        ...
        $CI->load->model('Web_settings');
        $CI->load->library('occational');
        $purchase_report = $CI->Reports->retrieve_dateWise_PurchaseReports($start_date, $end_date, $outlet_id, $supplier_id, $links, $per_page, $page);
        $purchase_amount = 0;
        if (!empty($purchase_report)) {
            $i = 0;
            foreach ($purchase_report as $k => $v) {
    ...
    public function daywise_sales_report($customer_id,$from_date,$to_date)
    {
        $CI = &get_instance();
        $CI->load->model('Customers');
        $CI->load->model('Web_settings');
        ...
        $this->db->select('product_information.product_id,product_information.unit,invoice_details.quantity,invoice.date as sale_date, product_information.product_name');
        $this->db->join('invoice', 'invoice.invoice_id = invoice_details.invoice_id','left');
        $this->db->join('product_information', 'product_information.product_id = invoice_details.product_id','left');
        if($customer_id)
        {
        ...
        foreach ($sales_data as $sale) {
            ...
            // If the date is not in the result array, initialize it
            if (!isset($dateWiseSalesData[$date])) {
            ...
            // Increment the total quantity for the date
            $dateWiseSalesData[$date]['total_quantity'] += $quantity;
            
            // Add product information to the date

            if (!isset($dateWiseSalesData[$date]['products'][$product_id])) {
                // Product doesn't exist for this date, so add a new entry
                $dateWiseSalesData[$date]['products'][$product_id] = [
                ...
                // Product already exists for this date, so update the quantity
                $dateWiseSalesData[$date]['products'][$product_id]['quantity'] += $quantity;
            }
       ...
       $sl = 0;
        foreach ($dateWiseSalesData as $key=>  $sales) {
            foreach ($sales['products'] as $productData) {
                if (!isset($uniqueProducts[$productData['product_id']])) {
                    $uniqueProducts[$productData['product_id']] = [
                        'total_quantity' => 0,
                    ];
                }
                $uniqueProducts[$productData['product_id']]['total_quantity'] += $productData['quantity'];
                $product_name = $productData['product_name'];
                if (!in_array($product_name, $uniqueProducts[$sl]['product_name'])) {
                    $uniqueProducts[$productData['product_id']]['product_id'] = $productData['product_id'];
                    $uniqueProducts[$productData['product_id']]['product_name'] = $product_name;
                    $uniqueProducts[$productData['product_id']]['unit'] = $productData['unit'];
     ...
     $reportList = $CI->parser->parse('report/daywise_sales_report', $data, true);
        return $reportList;
    }
    public function daywise_transaction_report($customer_id,$from_date,$to_date)
    {
        $CI = &get_instance();
        $CI->load->model('Customers');
        $CI->load->model('Web_settings');
        $currency_details = $CI->Web_settings->retrieve_setting_editdata();
        $customer = $CI->Customers->customer_list_ledger();
        $this->db->select('invoice.invoice_id,customer_information.customer_id,customer_information.customer_name,
        customer_information.customer_mobile,customer_information.customer_address,
        invoice.total_amount,invoice.due_amount,invoice.paid_amount,invoice.date as sale_date');
        ...
        foreach ($sales_data as $sale) {
            ...
            // If the date is not in the result array, initialize it
            if (!isset($dateWiseSalesData[$date]) && $dateWiseSalesData[$date] != '') {
                $dateWiseSalesData[$date] = [
                    'total_amount' => 0,
                    'paid_amount' => 0,
                    'products' => []
            ...
            // Increment the total quantity for the date
            $dateWiseSalesData[$date]['total_amount'] += $total_amount;
            $dateWiseSalesData[$date]['paid_amount'] += $paid_amount;
            if (!isset($dateWiseSalesData[$date]['products'][$customer_id])) {
                // Product doesn't exist for this date, so add a new entry

                $dateWiseSalesData[$date]['products'][$customer_id] = [
                    'customer_name' => $customer_name,
                    'total_amount' => $total_amount,
                    'opening_balance' => $CI->Customers->opening_balance($customer_id)[0]->opening_balance,
                    'closing_balance' => $CI->Customers->closing_balance($customer_id)[0]->closing_balance,
                ...
                // Product already exists for this date, so update the quantity
                $dateWiseSalesData[$date]['products'][$customer_id]['total_amount'] += $total_amount;
                $dateWiseSalesData[$date]['products'][$customer_id]['paid_amount'] += $paid_amount;
       ...
       $sl = 0;
        foreach ($dateWiseSalesData as $key=>  $sales) {
            foreach ($sales['products'] as $productData) {
                if (!isset($uniqueProducts[$productData['customer_id']])) {
                    $uniqueProducts[$productData['customer_id']] = [
                        'total_amount' => 0,
                        'paid_amount' => 0,
                    ];
                }
                $uniqueProducts[$productData['customer_id']]['total_amount'] += $productData['total_amount'];
                $uniqueProducts[$productData['customer_id']]['paid_amount'] += $productData['paid_amount'];

                $customer_name = $productData['customer_name'];
                if (!in_array($customer_id, $uniqueProducts[$sl]['customer_id'])) {
                    $uniqueProducts[$productData['customer_id']]['customer_id'] = $productData['customer_id'];
                    $uniqueProducts[$productData['customer_id']]['customer_name'] = $customer_name;
                    $uniqueProducts[$productData['customer_id']]['customer_address'] = $productData['customer_address'];
                    $uniqueProducts[$productData['customer_id']]['customer_mobile'] = $productData['customer_mobile'];
                    $uniqueProducts[$productData['customer_id']]['opening_balance'] = $productData['opening_balance'];
                    $uniqueProducts[$productData['customer_id']]['closing_balance'] = $productData['closing_balance'] + $productData['opening_balance'];
        ...
        // print_r($data);
        // exit();
     $reportList = $CI->parser->parse('report/daywise_transaction_report', $data, true);
        return $reportList;
    }

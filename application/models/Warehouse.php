...
class Warehouse extends CI_Model
{
    ...
    public function branch_list_new()
    {
        $this->db->select('a.*,b.*');
        $this->db->from('outlet_warehouse a');
        $this->db->join('central_warehouse b', 'b.warehouse_id = a.warehouse_id', 'left');
    ...
    //Update Outlet
    public function update_branch($data, $outlet_id)
    {
    ...
    public function get_central_warehouse($warehouse_id)
    {
        $this->db->select('*');
        $this->db->from('central_warehouse');
    ...
    public function outlet_or_cw_logged_in()
    {
        ...
        $user_id = $this->session->userdata('user_id');
        $outlet = $this->get_outlet_id_user_id($user_id);
    ...
    public function get_outlet_id_user_id($user_id)
    {
        $this->db->select('*');
        $this->db->from('users');
        $this->db->where('user_id', $user_id);
        ...
        return $this->central_warehouse();
// 
    }
    public function get_outlet_tech($outlet_id = null)
    {
        $this->db->select('a.*');

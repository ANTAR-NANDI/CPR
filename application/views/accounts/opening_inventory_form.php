                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="unit_price[]" class="form-control text-right" id="price_{sl}" value="{supplier_price}" onchange="calculate({sl})" onkeyup="calculate({sl})"></td>
                                        <td><input name="total_price[]" class=" form-control text-right row_total" id="row_total_{sl}" readonly></td>
                                    </tr>
                                    {/product_list}
                                </tbody>
                                <tfoot>

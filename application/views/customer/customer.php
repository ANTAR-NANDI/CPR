                ...
                <div class="col-md-3" style="margin-bottom: 15px;">
                    ...
                    <select name="outlet_id" class="form-control" id="outlet_id" required="" tabindex="3">
                       ...
                       <?php if (!($outlet_user)) { ?>
                        ...
                        <?php } ?>
                        <?php if ($outlet_user) { ?>
                            <option selected value="<?php echo html_escape($outlet_user[0]['outlet_id']) ?>"><?php echo html_escape($outlet_user[0]['outlet_name']); ?></option>
                            <?php }else foreach ($outlet_list as $outlet){ ?>

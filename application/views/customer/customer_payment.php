        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Ccustomer/customer_due_update', array('class' => 'form-vertical', 'id' => '', 'name' => '',))  ?>
                        ...
                        <div class="">
                            <table class="datatable table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <input hidden type="text" name="customer_id" value="<?php echo $customer_id ?>">
                                    <?php foreach ($customer_payment as $payment) { ?>
                                            <tr>
                                                <input hidden type="text" name="due_amount_hidden" id="due_amount_hidden_<?php echo $sl; ?>" value="<?php echo $payment['due_amount'] ?>">
                                                <input hidden  type="text" name="invoice_id[]" id="invoice_id" value="<?php echo $payment['invoice_id'] ?>">
                                                <input hidden type="text" name="previous_paid_amount[]" value="<?php echo $payment['paid_amount'] ?>">
                                                <input hidden type="text" name="total_amount[]" value="<?php echo $payment['net_total'] ?>">
                                                <td><?php echo $sl++; ?></td>
                                                <td><?php echo $payment['invoice_id'] ?></td>
                                                <td><?php echo html_escape($payment['date']); ?></td>
                                                <td id="total_amount_<?php echo $sl; ?>"><?php echo html_escape($payment['net_total']); ?></td>

  ...
  <div class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <?php if (
        ...
        $this->permission1->method('pos_setting', 'update')->access() ||
        $this->permission1->method('invoice_setting', 'update')->access()
      ) { ?>
        <li class="treeview <?php if ($this->uri->segment('1') == "Cinvoice" || $this->uri->segment('1') == "Corder"  || $this->uri->segment('1') == "Cquotation") {
          ...
          <ul class="treeview-menu">
            ...
            <?php if ($this->permission1->method('pos_setting', 'update')->access()) { ?>
              <li class="treeview <?php if (
                                    $this->uri->segment('2') == "pos_setting_list"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Csettings/pos_setting_list'
                                                  ); ?>"><?php echo display(
                                                            'pos_setting'
                                                          ); ?></a></li>
            <?php } ?>
          ...
          <ul class="treeview-menu">
            ...
            <!--              <li class="treeview --><?php //if (
                                                      ...
                                                      ?><!--"><a href="--><?php //echo base_url(
                                                                          ...
                                                                          //                                                  ); 
                                                                          ?><!--">--><?php //echo display('wastage_return_list'); 
                                                                                      ?><!--</a></li>-->
            <!--            --><?php //} 
                                ?>
          ...
          <ul class="treeview-menu">
            ...
            <?php if ($this->permission1->method('rqsn_form', 'create')->access()) { ?>
              <li class="treeview <?php if ($this->uri->segment('1') == ("Crqsn") && $this->uri->segment('2') == ("index")) {
                                    ...
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url('Crqsn/transfer_form') ?>">Transfer Products</a></li>
            <?php } ?>
            ...
            <?php } ?> -->
                  ...
                  <!--                                <li class="treeview --><?php //if ($this->uri->segment('2') == ("aprove_rqsn_purchase")) {
                                                                              ...
                                                                              //                                    echo " ";
                                                                              //                                } 
                                                                              ?><!--"><a href="--><?php //echo base_url('Crqsn/aprove_rqsn_purchase') 
                                                                                                  ?><!--">Purchase Requisition Approve </a></li>-->
                  <!--                            --><?php //} 
                                                      ?>
                </ul>
              </li>
        ...
        <li class="treeview <?php if (
          ...
          <ul class="treeview-menu">
            ...
            <!--              <li class="treeview --><?php //if ($this->uri->segment('1') == "Cptype") {
                                                      ...
                                                      //                                    echo " ";
                                                      //                                  } 
                                                      ?><!--"><a href="--><?php //echo base_url('Cptype'); 
                                                                          ?><!--">Product Type</a></li>-->
            <!--            --><?php //} 
                                ?>
            <!-- Category menu end -->
            ...
            <!--              <li class="treeview --><?php //if (
                                                      ...
                                                      //                                    echo " ";
                                                      //                                  } 
                                                      ?><!--"><a href="--><?php //echo base_url('Cproduct/attributes'); 
                                                                          ?><!--">Attributes</a></li>-->
            <!--            --><?php //} 
                                ?>
            <!--            --><?php //if (
            ...
            <!--              <li class="treeview --><?php //if (
                                                      ...
                                                      //                                    echo " ";
                                                      //                                  } 
                                                      ?><!--"><a href="--><?php //echo base_url('Cproduct/color'); 
                                                                          ?><!--">Color</a></li>-->
            <!--            --><?php //} 
                                ?>
          </ul>
      ...
      <?php if (
        $this->permission1->method('vat_tax', 'create')->access() ||
        $this->permission1->method('add_vat_tax', 'create')->access() ||
        $this->permission1->method('manage_vat', 'read')->access()
      ) { ?>
        <li class="treeview <?php if (
                              $this->uri->segment('2') == "index" ||
                              $this->uri->segment('2') == "Cvat" ||
                              $this->uri->segment('2') == "Cvat" ||
                              $this->uri->segment('2') == "Cvat"
                            ) {
                              echo "active";
          ...
          <a href="#">
            <i class="fa fa-money"></i><span>Vat & Tax</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <?php if ($this->permission1->method('add_vat_tax', 'create')->access()) { ?>
              <li class="treeview <?php if (
                                    $this->uri->segment('1') == "Cvat" &&
                                    $this->uri->segment('2') == "add_vat_tax"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
            ...
            <?php if ($this->permission1->method('manage_vat', 'read')->access()) { ?>
              <li class="treeview <?php if ($this->uri->segment('2') == "manage_vat") {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "Cpurchase") {
          ...
          <ul class="treeview-menu">
            ...
            <?php if (
              ...
              <li class="treeview <?php if (
                                    $this->uri->segment('2') == "add_purchase_csv"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Cpurchase/add_purchase_csv'
                                                  ); ?>"><?php echo "Purchase CSV"; ?></a></li>
            <?php } ?>
      ...
      <?php if (
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "Creport" && ($this->uri->segment('1') == "accounts" && $this->uri->segment('2') == "opening_inventory")) {
                              echo "active";
                            } else {
                              echo " ";
                            } ?>">
          ...
          <ul class="treeview-menu">
            <?php if ($this->permission1->method('stock_report', 'read')->access()) { ?>
              ...
              <li class="treeview <?php if (
                                    $this->uri->segment('1') == "Creport" &&
                                    $this->uri->segment('2') == "expiry_stock"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url('Creport/expiry_stock'); ?>">Expiry Stock report
                </a></li>
            <?php } ?>
            ...
            <?php if ($this->permission1->method('outlet_stock', 'read')->access() || $this->permission1->method('outlet_stock', 'read')->access() || $this->permission1->method('outlet_stock', 'read')->access()) { ?>
              <li class="treeview <?php
                                  if ($this->uri->segment('1') == ("Crqsn") && $this->uri->segment('2') == ("stock")) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  }
                ...
                <ul class="treeview-menu">
                  ...
                  <?php if ($this->permission1->method('outlet_stock', 'create')->access()) { ?>
                    <li class="treeview <?php if ($this->uri->segment('1') == ("Crqsn") && $this->uri->segment('2') == ("stock")) {
                                          echo "active";
                                        } else {
                                          echo " ";
                                        } ?>"><a href="<?php echo base_url('Crqsn/stock') ?>">Stock Report</a>
                    </li>

                    <li class="treeview <?php if ($this->uri->segment('1') == ("Crqsn") && $this->uri->segment('2') == ("expiry_stock")) {
                                          echo "active";
                                        } else {
                                          echo " ";
                                        } ?>"><a href="<?php echo base_url('Crqsn/expiry_stock') ?>">Expiry Stock Report</a>
                    </li>
                  <?php } ?>
      ...
      <?php if (
        ...
        $this->permission1->method('supplier_wise_stock_report', 'read')->access()
      ) { ?>
        <li class="treeview <?php if (
          ...
          <ul class="treeview-menu">
            ...
            <?php if (
              ...
              <li class="treeview <?php if (
                                    $this->uri->segment('2') == "supplier_wise_sales_report"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Admin_dashboard/supplier_wise_sales_report'
                                                  ); ?>">Sales Report (Supplier Wise)</a></li>
            <?php } ?>
            <?php if (
            ...
            <?php if (
              ...
              <li class="treeview <?php if (
                                    $this->uri->segment('2') == "supplier_wise_stock_report"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Creport/supplier_wise_stock_report'
                                                  ); ?>"><?php echo display('supplier_wise_stock_report'); ?></a></li>
            <?php } ?>
            ...
            <?php if (
              ...
              <li class="treeview <?php if (
                                    $this->uri->segment('2') == "product_wise_purchase_report"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Creport/product_wise_purchase_report'
                                                  ); ?>"><?php echo "Product Wise Purchase Report"; ?></a></li>
            ...
            <?php } ?>
              ...
              <li class="treeview <?php if (
                                    $this->uri->segment('2') == "daywise_sales_report"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Creport/daywise_sales_report'
                                                  ); ?>">Daywise Product Sales Report</a></li>
            <li class="treeview <?php if (
                                    $this->uri->segment('2') == "daywise_transaction_report"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Creport/daywise_transaction_report'
                                                  ); ?>">Daywise Trasaction Report</a></li>

                               <li class="treeview <?php if (
                                    $this->uri->segment('2') == "technician_earning_report"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Creport/technician_earning_report'
                                                  ); ?>"><?php echo "Technician Earning Report"; ?></a></li>
      ...
      <?php if (
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "accounts" && $this->uri->segment('2') != "opening_inventory") {
                              echo "active";
                            } else {
                              echo " ";
                            } ?>">
                ...
                <ul class="treeview-menu">
                  ...
                  <!--                              <li class="treeview --><?php //if (
                                                                            ...
                                                                            ?><!--"><a href="--><?php //echo base_url(
                                                                                                ...
                                                                                                //                                  ); 
                                                                                                ?><!--">--><?php //echo "Profit And Loss Account"; 
                                                                                                            ?><!--</a></li>-->
                  <!--                          --><?php //} 
                                                    ?>
      ...
      <?php if (
        ...
        $this->permission1->method('add_phrase', 'create')->access() ||
            ...
            <?php if (
              ...
              <li class="treeview <?php if (
                ...
                <ul class="treeview-menu">
                  ...
                  <?php if (
                    $this->permission1->method('add_phrase', 'create')->access() ||
                    $this->permission1->method('add_phrase', 'update')->access()
                  ) { ?>
                    <li class="treeview <?php if (
                                          $this->uri->segment('1') == "Language" &&
                                          $this->uri->segment('2') == ""
                      ...
                      <a href="<?php echo base_url('Language/phrase'); ?>"><?php echo display('phrase'); ?></a>
                    </li>
                  <?php } ?>
                  <?php if (
                    $this->permission1->method('add_language', 'create')->access() ||
...
<!-- Crm Module Menu Start Developed By ANTAR NANDI -->
        <li class="treeview <?php if (
                              $this->uri->segment('1') == "crm"
                            ) {
                              echo "active";
                            } else {
                              echo " ";
        ...
        <li class="treeview <?php if (
                      $this->uri->segment('2') == "manage_card"
                    ) {
                      echo "active";
                    } else {
                      echo " ";
                      ...
                      'crm/manage_card'
                    ); ?>"><?php echo "Manage Card"; ?></a>
        </li>
        <li class="treeview <?php if (
              $this->uri->segment('2') == "earning_setting"
            ) {
              echo "active";
            } else {
              echo " ";
                    ...
                    'crm/earning_setting'
                  ); ?>"><?php echo "Earning Setting"; ?></a>
        </li>
        <li class="treeview <?php if (
                  $this->uri->segment('2') == "manage_earning_setting"
                ) {
                  echo "active";
                } else {
                  echo " ";
                } ?>"><a href="<?php echo base_url(
                'crm/manage_earning_setting'
              ); ?>"><?php echo "Manage Earning Setting"; ?></a>
        </li>
         ...
         <li class="treeview <?php if (
          ...
          echo " ";
                          ...
                          'crm/burning_setting'
                        ); ?>"><?php echo "Burning Setting"; ?></a></li>
                        <li class="treeview <?php if (
                  $this->uri->segment('2') == "manage_burning_setting"
                ) {
                  echo "active";
                } else {
                  echo " ";
                } ?>"><a href="<?php echo base_url(
                'crm/manage_burning_setting'
              ); ?>"><?php echo "Manage Burning Setting"; ?></a>
        </li>
        <li class="treeview <?php if (
                  $this->uri->segment('2') == "earning_burning_report"
                ) {
                  echo "active";
                } else {
                  echo " ";
                } ?>"><a href="<?php echo base_url(
                'crm/earning_burning_report'
              ); ?>"><?php echo "Earning-Burning Report"; ?></a>
        </li>
        <li class="treeview <?php if (
                  $this->uri->segment('2') == "invoice_report"
                ) {
                  echo "active";
                } else {
                  echo " ";
                ...
                'crm/invoice_report'
              ); ?>"><?php echo "Invoice Report"; ?></a>
        </li>
        <li class="treeview <?php if (
                  $this->uri->segment('2') == "product_earning_report"
                ) {
                  echo "active";
                } else {
                  echo " ";
                } ?>"><a href="<?php echo base_url(
                'crm/product_earning_report'
              ); ?>"><?php echo "Product Earning Report"; ?></a>
        </li>
        <li class="treeview <?php if (
                  $this->uri->segment('2') == "product_burning_report"
                ) {
                  echo "active";
                } else {
                  echo " ";
                } ?>"><a href="<?php echo base_url(
                'crm/product_burning_report'
              ); ?>"><?php echo "Product Burning Report"; ?></a>
        </li>
          </ul>
        </li>       
<!-- Crm Module Menu Start Developed By ANTAR NANDI -->
...
<!----------------------------------------- CPR Module Development ----------------------------------- -->
      <?php if (
        ...
        <li class="treeview <?php if ($this->uri->segment('1') == "Cservice") {
          ...
          <li class="treeview <?php if (
                    ...
                    $this->uri->segment('2') == "add_category"
                  ) {
                    echo "active";
                  } else {
                    echo " ";
                  } ?>"><a href="<?php echo base_url('Cservice/add_category'); ?>"><?php echo "Add Category" ?></a>
          </li>
          <li class="treeview <?php if (
                                   $this->uri->segment('1') == "Cservice" &&
                                    $this->uri->segment('2') == "manage_category"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                                    'Cservice/manage_category'
                                                  ); ?>"><?php echo "Manage Category"; ?></a>
          </li>
            <?php if (
              $this->permission1->method('create_service', 'create')->access()
            ) { ?>
            ...
            <?php } ?>
            <li class="treeview <?php if ($this->uri->segment('1') == "Cservice" && $this->uri->segment('2') == "technician_earning_report" ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>">
                <a href="#">
                  <span><?php echo "Service Reports"; ?></span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li><a href="<?php echo base_url('Cservice/technician_earning_report'); ?>">1. Summary Report</a></li>
                    <li><a href="<?php echo base_url('Cservice/purchase_report'); ?>">2. Purchase Report</a></li> 
                    <li><a href="<?php echo base_url('Cservice/product_wise_stock_report'); ?>">3. Stock Report</a></li> 
                    <li><a href="<?php echo base_url('Cservice/warranty_report'); ?>">4. Warranty Report</a></li>  
                    <li><a href="<?php echo base_url('Cservice/sales_report'); ?>">5. Sales Report</a></li> 
                    <li><a href="<?php echo base_url('Cservice/technician_payment_report'); ?>">6. Payment Report</a></li> 
                    <li><a href="<?php echo base_url('Cservice/account_report'); ?>">7. Account Report</a></li> 
      ...
      <?php } ?>      
      <!-- New Accounts Module Developed by ANTAR NANDI -->
        <li class="treeview <?php if ($this->uri->segment('1') == "accounts" && $this->uri->segment('2') != "opening_inventory") {
                              echo "active";
                            } else {
                              echo " ";
          ...
          <ul class="treeview-menu">
              <li class="treeview <?php if (
                                    $this->uri->segment('2') == "debit_voucher_new"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                  } ?>"><a href="<?php echo base_url(
                                        'accounts/debit_voucher_new'
                                      ); ?>"><?php echo "Payment Voucher"; ?></a></li>  
          </ul>
        </li>
       <!-- New Accounts Module Development Done By ANTAR NANDI -->
       <!-- Technician Module -->
       <li class="treeview <?php if ($this->uri->segment('1') == "Ctechnician") {
                              echo "active";
                            } else {
                              echo " ";
                            } ?>">
          <a href="#">
            <i class="fa fa-money"></i><span><?php echo "Technician"; ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
          <li class="treeview <?php if (
                                    $this->uri->segment('1') == "Ctechnician" && $this->uri->segment('2') == "add"
                                  ) {
                                    echo "active";
                                  } else {
                                    echo " ";
                                        ...
                                        'Ctechnician/add'
                                      ); ?>"><?php echo "Add Technician"; ?></a></li>  
              <li class="treeview <?php if ($this->uri->segment('1') == "Ctechnician" && 
            $this->uri->segment('2') == "manage_technician"
          ) {
            echo "active";
          } else {
            echo " ";
          } ?>"><a href="<?php echo base_url(
                            'Ctechnician/manage_technician'
                          ); ?>"><?php echo "Manage Technician"; ?></a>
              </li>
              <li class="treeview <?php if (
                                    $this->uri->segment('1') == "Ctechnician"
                                    && $this->uri->segment('2') != "manage_commission"
                                    && $this->uri->segment('2') != "manage_technician"
            ...
            echo " ";
                            ...
                            'Ctechnician/manage_commission'
                          ); ?>"><?php echo "Manage Commission"; ?></a>
              </li>
          </ul>
      </li>
        <li class="treeview <?php if ($this->uri->segment('1') == "Fund_Deduction") {
                              echo "active";
                            } else {
                              echo " ";
                            } ?>">
          <a href="#">
            <i class="fa fa-money"></i><span><?php echo "Fund & Deduction"; ?></span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
              <li class="treeview <?php if (
                      $this->uri->segment('1') == "Fund_Deduction"
                    ) {
                      echo "active";
                    } else {
                      echo " ";
                          ...
                          'Fund_Deduction'
                        ); ?>"><?php echo "Add Fund & Deduction"; ?></a>
              </li> 
              <li class="treeview <?php if (
            $this->uri->segment('2') == "manage_fund_deductions"
          ) {
            echo "active";
          } else {
            echo " ";
          } ?>"><a href="<?php echo base_url(
                            'Fund_Deduction/manage_fund_deductions'
                          ); ?>"><?php echo "Manage Fund Deduction"; ?></a>
              </li> 
          </ul>
        </li>
       <!-- Technician Module  -->

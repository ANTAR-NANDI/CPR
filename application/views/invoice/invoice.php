                ...
                <form method="post" id="ProjectEditForm" action="<?php echo base_url('Cinvoice/due_payment/') ?>">
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6" style="display: none" id="card_div">
                                <div class="form-group row">
                                    <label for="card" class="col-sm-3 col-form-label">Card Type <i class="text-danger">*</i></label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group row">
                                    <label for="p_amount" class="col-sm-3 col-form-label"> Amount <i class="text-danger">*</i></label>

                                    <div class="col-sm-8" id="ammnt_1">

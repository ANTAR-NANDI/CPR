                                ...
                                <table class="table table-xs table-bordered" style="width: 100%;">
                                    <thead>
                                        ...
                                        <th class="text-center">ক্র. নং </th>
                                            ...
                                            <th class="text-center">মোট দাম</th>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($invoice_all_data as $invoice_data) { ?>
                                            <tr>
                                                 <td align="center" class="td-style" width="5%">
                                                    <?php echo $CI->converter->en2bn(abs($sl));
                                                ...
                                                <td align="center" class="td-style" width="15%">
                                                    <?php echo $CI->converter->en2bn(abs($invoice_data['quantity']). " ( ". $invoice_data['unit'] . " ) ");
                                                ...
                                                <td align="right" class="td-style">
                                                    <nobr>
                                                        ...
                                                        if ($position == 0) {
                                                            ...
                                                            $total_subtotal += $invoice_data['rate'] * $invoice_data['quantity'];
                                                        } else {
                                                ...
                                                <td align="right" class="td-style" style="width: 20mm !important;">

                                                    <?php
                                                    if ($position == 0) {
                                                        echo  $currency . ' ' . $CI->converter->en2bn($invoice_data['total_price_wd'] + $invoice_data['discount_per']);
                                                    } else {
                                                        echo  $CI->converter->en2bn($invoice_data['total_price_wd'] + $invoice_data['discount_per']) . ' ' . $currency;
                                                    }
                                                ...
                                                <td align="right" class="td-style" style="width: 15mm !important;">
                                                    ...
                                                    <?php
                                                    if ($position == 0) {
                                                        echo $CI->converter->en2bn($invoice_data['discount_per']);
                                                        $total_product_discount += $invoice_data['discount_per'];
                                                        //$distributed_discount += ($invoice_data['distributed_discount'] - $invoice_data['discount_per']);
                                                    }
                                                    //                                                $s_total += $invoice_data['total_price_wd'];
                                                    ?>
                                                ...
                                                <td align="right" class="td-style" style="width: 15mm !important;">
                                                    ...
                                                    <?php
                                                    if ($position == 0) {
                                                        $total_price_wv += $invoice_data['total_price'] + $invoice_data['tax'] + $invoice_data['vat'];
                                                        echo  $currency . ' ' .  $CI->converter->en2bn(abs($invoice_data['total_price'] + $invoice_data['tax'] + $invoice_data['vat']));
                                                    } else {
                                                        echo $CI->converter->en2bn($invoice_data['total_price'] + $invoice_data['tax'] + $invoice_data['vat']) . ' ' . $currency;
                                                        $total_price_wv += $invoice_data['total_price'] + $invoice_data['tax'] + $invoice_data['vat'];
                                                    }
                                                    //                                                $s_total += $invoice_data['total_price_wd'];
                                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" class="td-style">
                                                <nobr>
                                                    ...
                                                    <?php echo html_escape((($position == 0) ? $currency . ' ' . $CI->converter->en2bn($total_subtotal) : $CI->converter->en2bn($total_subtotal) . ' ' . $currency)) ?>
                                            ...
                                            <td align="right" class="td-style">
                                                ...
                                                <?php } else { ?>
                                                    <nobr>
                                                        ...
                                                        <?php echo html_escape((($position == 0) ? $currency . ' ' . $CI->converter->en2bn($total_product_discount) : $CI->converter->en2bn($total_product_discount) . ' ' . $currency)) ?>
                                            ...
                                            <td align="right" class="td-style">
                                                <nobr>
                                                    ...
                                                    <?php echo html_escape((($position == 0) ? $currency . ' ' . $CI->converter->en2bn($total_price_wv) : $CI->converter->en2bn($total_price_wv) . ' ' . $currency)) ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="no_border" align="right" colspan="5">
                                                <nobr>[-] স্পেশাল ডিসকাউন্ট</nobr>
                                            </td>
                                            <td align="right" class="td-style">
                                                <nobr>

                                                    <?php echo html_escape((($position == 0) ? $currency . ' ' . $CI->converter->en2bn(($total_discount - $total_product_discount) ) : $CI->converter->en2bn($total_discount - $total_product_discount ) . ' ' . $currency)) ?>
                                        ...
                                        <?php if ($sales_return > 0) { ?>
                                            <tr>
                                                <td align="left" colspan="5" style="border: none !important;">
                                                    <nobr></nobr>
                                                </td>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        ...
                                        <div class="inv-footer-due">
                                            ...
                                            <?php } else { ?>
                                                <span style="display: block;">মোট প্রাপ্তিঃ <?php
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <div class="inv-footer-paid">
                                            ...
                                            <?php if ($sales_return > 0) { ?>
                                                <span style="display: block;">রিফান্ড বকেয়ার পরিমাণঃ <?php echo html_escape((($position == 0) ? $currency . ' ' . $CI->converter->en2bn($customer_ac) : $CI->converter->en2bn($customer_ac) . ' ' . $currency)) ?>
                                                </span>

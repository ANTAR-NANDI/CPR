                ...
                <div class="panel panel-bd lobidrag">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="sale_code" class="col-sm-4 col-form-label">Tag Code</label>
                                    <div class="col-sm-8">
                                        <input class="form-control" value="<?php echo $tag_code ?>" name="tag_code" type="text" id="tag_code" placeholder="Tag Code" required tabindex="1">
                                    </div>
                                </div>
                            </div>

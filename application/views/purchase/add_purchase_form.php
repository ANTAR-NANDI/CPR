                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <?php if ($outlet_id == 'HK7TGDT69VFMXB7') { ?>
                                            <input type="text" style="font-size:15px" name="" class="form-control col-sm-2 box" placeholder='' id="add_item_m" autocomplete='off' tabindex="1" value="Central Warehouse" readonly>
                                            <input type="hidden" id="outlet_name" name="outlet_name" value="<?= $outlet_id ?>">
                                        <?php } else { ?>
                                            <input type="text" style="font-size:15px" name="" class="form-control col-sm-2 box" placeholder='' id="add_item_m" autocomplete='off' tabindex="1" value="<?= $outlet_list[0]['outlet_name'] ?>" readonly>
                                            <input type="hidden" id="outlet_name" name="outlet_name" value="<?= $outlet_id ?>">
                                        <?php } ?>
                                    </div>
                                </div>

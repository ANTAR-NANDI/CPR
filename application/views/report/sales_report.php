                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12" style="margin-bottom: 10px;">
                                ...
                                <?php } else { ?>
                                    <input type="hidden" name="outlet_id" class="form-control" id="outlet_id" style="margin-bottom: 10px;" value="<?php echo $logged_outlet_id ?>" readonly>
                                <?php } ?>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            foreach ($sales_report as $sales) {
                                                ...
                                                <tr>
                                                    <td><?php echo $sl; ?></td>
                                                    <td><?php echo $sales['outlet_name'] ?></td>
                                ...
                                <table class="table table-bordered table-striped table-hover" id="salesReportTable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo "Delivery Charge" ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            $sl = 0;
                                            foreach ($sales_report as $sales) {
                                                // $received = ($sales['paid_amount'] ? $sales['paid_amount'] : 0.00) - ($sales['changeamount'] ? $sales['changeamount'] : 0.00);
                                                $received = ($sales['paid_amount'] ? $sales['paid_amount'] : 0.00);
                                                $sl++;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo ceil($sales['total_amount']) + $sales['total_discount'] - $sales['service_charge'] - $sales['shipping_cost']; ?></td>
                                                    <td><?php echo $sales['total_discount'] ?></td>
                                                    <td><?php echo $sales['service_charge'] ? $sales['service_charge'] : 0; ?></td>
                                                    <td><?php echo $sales['shipping_cost'] ? $sales['shipping_cost'] : 0; ?></td>
                                                    ...
                                                    <td><?php echo $sales['cheque'] ? $sales['cheque'] : 0.00 ?></td>
                                                    <td><?php echo $sales['bank'] ? $sales['bank'] : 0.00 ?></td>
                                                    ...
                                                    <?php
                                                    // $total_sales += ceil($sales['total_amount']) + $sales['total_discount'] - $sales['service_charge'] - $sales['shipping_cost'];
                                                    // $total_discount += $sales['total_discount'];
                                                    // $received += $total_received;
                                                    // $total_due += $sales['due_amount'];
                                                    // $total_service += $sales['service_charge'];
                                                    // $total_shipping += $sales['shipping_cost'];
                                                    // $total_return += $sales['sales_return'];
                                                    // $total_quantity += $sales['qnty'];
                                                    // $total_cash += $sales['cash'];
                                                    // $total_cheque += $sales['cheque'];
                                                    // $total_bank += $sales['bank'];
                                                    ...
                                                    $total_service += $sales['service_charge'];
                                                    $total_shipping += $sales['shipping_cost'];
                                                    $total_net_sales += ceil($sales['total_amount']);
                                                    $total_return += $sales['sales_return'];
                                                    $total_due += $sales['due_amount'];
                                                    $total_cash += $sales['cash'];
                                                    $total_cheque += $sales['cheque'];
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                <th class="text-center" colspan="21"><?php echo display('not_found'); ?></th>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="text-right"><b><?php echo number_format($total_quantity); ?></b></td>

                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_sales) : number_format($total_sales) . " $currency") ?></b></td>

                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_discount) : number_format($total_discount) . " $currency") ?></b></td>

                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_service) : number_format($total_service) . " $currency") ?></b></td>

                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_shipping) : number_format($total_shipping) . " $currency") ?></b></td>

                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_net_sales) : number_format($total_net_sales) . " $currency") ?></b></td>
                                            ...
                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_cheque) : number_format($total_cheque) . " $currency") ?></b></td>
                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_bank) : number_format($total_bank) . " $currency") ?></b></td>
                                            ...
                                            <td class="text-right"><b><?php echo (($position == 0) ? "$currency " . number_format($total_received) : number_format($total_received) . " $currency") ?></b></td>

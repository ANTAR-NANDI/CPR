...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <div class="header-title">
            <h1><?php echo "Summary Report" ?></h1>
            <small><?= $heading_text ?></small>
            <ol class="breadcrumb">
                <li><a href="#"><i class="pe-7s-home"></i> <?php echo display('home') ?></a></li>
                <li><a href="#"><?php echo "Summary Report" ?></a></li>
                                ...
                                <table class="table table-striped table-bordered" cellspacing="0" width="100%" id="TechnicianEarningReport">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Supplier Payment</th>
                                            <th class="text-center">Technician Payment</th>
                                            <th class="text-center">Delivery Staus</th>

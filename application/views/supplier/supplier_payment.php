        ...
        <div class="row">
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php echo form_open_multipart('Csupplier/supplier_due_update', array('class' => 'form-vertical', 'id' => '', 'name' => '',))  ?>
                        ...
                        <div class="">
                            <table class="datatable table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <input hidden type="text" name="supplier_id" value="<?php echo $supplier_id ?>">
                                    <?php foreach ($supplier_payment as $payment) { ?>
                                            <tr>
                                                ...
                                                <input hidden  type="text" name="purchase_id[]" id="purchase_id" value="<?php echo $payment['purchase_id'] ?>">
                                                <input hidden type="text" name="previous_paid_amount[]" value="<?php echo $payment['paid_amount'] ?>">
                                                <input hidden type="text" name="total_amount[]" value="<?php echo $payment['grand_total_amount'] ?>">
                                                <td><?php echo $sl++; ?></td>
                                                <td><?php echo $payment['purchase_id'] ?></td>
                                                <td><?php echo html_escape($payment['purchase_date']); ?></td>
                                                <td id="total_amount_<?php echo $sl; ?>"><?php echo html_escape($payment['grand_total_amount']); ?></td>
...
<script type="text/javascript">
    ...
    function quantity_calculate(item) {
        ...
        total_amount = parseFloat($('#total_amount_'+item).html()); 
        ...
        {
            $('#pay_amount_'+item).val(total_amount - previous_paid)
            $('#due_amount_'+item).html(0);
            $('#due_payment_'+item).val(0);
        }
        else{
            $('#due_amount_'+item).html(total_amount - (pay_amount + previous_paid ));
            $('#due_payment_'+item).val(total_amount - (pay_amount + previous_paid ));

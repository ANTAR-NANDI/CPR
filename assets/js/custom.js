...
$(document).ready(function () {
  ...
  // @ANTAR NANDI
  var total_technicians = $("#total_technicians").val();
  var commission_table = $("#commission_list").DataTable({
    aaSorting: [[1, "asc"]],
    ...
    lengthMenu: [
      [10, 25, 50, 100, 250, 500, total_technicians],
      [10, 25, 50, 100, 250, 500, "All"],
    ],
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Ctechnician/Commission_List",
      data: function (d) {
        (d.csrf_test_name = CSRF_TOKEN), (d.outlet_id = outlet_id);
      },
    },
  ...
  var total_fund_deductions = $("#total_fund_deductions").val();
  var fund_deduction_table = $("#fund_deduction_list").DataTable({
    aaSorting: [[1, "asc"]],
    columnDefs: [{ bSortable: false, aTargets: [0] }],
    processing: true,
    serverSide: true,
    ...
    lengthMenu: [
      [10, 25, 50, 100, 250, 500, total_fund_deductions],
      [10, 25, 50, 100, 250, 500, "All"],
    ],
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Fund_Deduction/FundDeduction_List",
      data: function (d) {
        (d.csrf_test_name = CSRF_TOKEN), (d.outlet_id = outlet_id);
      },
    },
  ...
  var service_categories_table = $("#service_category_list").DataTable({
    aaSorting: [[0, "asc"]],
    columnDefs: [{ bSortable: false, aTargets: [0] }],
    processing: true,
    serverSide: true,
    ...
    lengthMenu: [
      [10, 25, 50, 100, 250, 500, total_categories],
      [10, 25, 50, 100, 250, 500, "All"],
    ],
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/Category_List",
      data: function (d) {
        (d.csrf_test_name = CSRF_TOKEN), (d.outlet_id = outlet_id);
      },
    },
  ...
  var total_services = $("#total_services").val();
  var service_categories_table = $("#service_list").DataTable({
    aaSorting: [[0, "asc"]],
    columnDefs: [{ bSortable: false, aTargets: [0] }],
    processing: true,
    serverSide: true,
    ...
    lengthMenu: [
      [10, 25, 50, 100, 250, 500, total_services],
      [10, 25, 50, 100, 250, 500, "All"],
    ],
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/Service_List",
      data: function (d) {
        (d.csrf_test_name = CSRF_TOKEN), (d.outlet_id = outlet_id);
      },
    },
  ...
  var service_invoice_list = $("#service_invoice_list").DataTable({
    ...
    lengthMenu: [
      [10, 25, 50, 100, 250, 500, total_service_invoice],
      [10, 25, 50, 100, 250, 500, "All"],
    ],
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/Service_Invoice_List",
      data: function (d) {
  ...
  $("#outlet_id,#technician_id,#from_date,#to_date,#payment_status,#delivery_status").on("change", function (e) {
    ...
    payment_status = $("#payment_status").val();
    delivery_status = $("#delivery_status").val();
    service_invoice_list.ajax.reload();
  });
  var total_technicians = $("#total_technicians_list").val();
  var technician_table = $("#technician_list").DataTable({
    aaSorting: [[1, "asc"]],
    columnDefs: [{ bSortable: false, aTargets: [0] }],
    processing: true,
    serverSide: true,
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Ctechnician/technician_List",
      data: function (d) {
        (d.csrf_test_name = CSRF_TOKEN), (d.outlet_id = outlet_id);
      },
    },
...
$(document).ready(function () {
  ...
  var table = $("#Service_Stock_Report").DataTable({
    responsive: true,
    aaSorting: [[3, "asc"]],
    columnDefs: [{ bSortable: false, aTargets: [0, 2, 4, 5, 6, 7, 8, 9] }],
    processing: true,
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/Service_Stock_Report",
      data: function (d) {
        d.csrf_test_name = CSRF_TOKEN;
        d.pr_status = pr_status;
        d.product_status = product_status;
...
$(document).ready(function () {
  ...
  var table = $("#TechnicianEarningReport").DataTable({
    responsive: true,
    ...
    buttons: [
      ...
      {
        extend: "csv",
        title: "Technician Earning Report",
        className: "btn-sm prints",
        footer: true,
      },
      {
      ...
      {
        extend: "print",
        title: "<center>Technician Earning Report</center>",
        className: "btn-sm prints",
        footer: true,
        customize: function (win) {
          var last = null;
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/TechnicianEarningReport",
      data: function (d) {
        d.csrf_test_name = CSRF_TOKEN;
        d.outlet_id = outlet_id;
        d.from_date = from_date;
    ...
    columns: [
      ...
      {
        data: "net_amount",
        class: "net_amount text-right",
      },

      {
        data: "technician_percentage",
        class: "technician_percentage text-right",
      },
...
$(document).ready(function () {
  ...
  var PurchaseReport = $("#PurchaseReport").DataTable({
    responsive: true,
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/ProductPurchaseReport",
      data: function (d) {
        d.csrf_test_name = CSRF_TOKEN;
        d.outlet_id = outlet_id;
        d.from_date = from_date;
...
$(document).ready(function () {
  ...
  var table = $("#WarrantyReport").DataTable({
    responsive: true,
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/ajaxWarrantyReport",
      data: function (d) {
        d.csrf_test_name = CSRF_TOKEN;
        d.outlet_id = outlet_id;
        d.from_date = from_date;
...
$(document).ready(function () {
  ...
  $("#from_date, #to_date,#outlet_id").on("change", function (e) {
    from_date = $("#from_date").val();
    to_date = $("#to_date").val();
    outlet_id = $("#outlet_id").val();
    SalesReport.ajax.reload();
  });

  var SalesReport = $("#SalesReport").DataTable({
    responsive: true,
    ...
    buttons: [
      ...
      {
        extend: "print",
        title: "<center>Sales Report</center>",
        className: "btn-sm prints",
        footer: true,
        customize: function (win) {
          var last = null;
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/ajaxSalesReport",
      data: function (d) {
        d.csrf_test_name = CSRF_TOKEN;
        d.outlet_id = outlet_id;
        d.from_date = from_date;
...
$(document).ready(function () {
  ...
  var table = $("#TechnicianPaymentReport").DataTable({
    responsive: true,
    ...
    serverMethod: "post",
    ajax: {
      url: base_url + "Cservice/TechnicianPaymentReport",
      data: function (d) {
        d.csrf_test_name = CSRF_TOKEN;
        d.outlet_id = outlet_id;
        d.from_date = from_date;
